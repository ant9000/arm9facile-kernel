/*
 * arch/arm/mach-lpc32xx/arm9facile.c
 *
 * Author: Antonio Galea <antonio.galea@gmail.com>
 * 
 * Based on phy3250.c from
...
static struct clcd_panel conn_lcd_panel = {
	.mode		= {
#if defined (CONFIG_ARM9FACILE_800X480_LCD)
                .name           = "800x480 @ 70",
                .refresh        = 70,
                .xres           = 800,
                .yres           = 480,
 ...
 * AMBA SSP (SPI)
 */
static void arm9facile_spi_cs_set(u32 control)
{
...
static struct pl022_config_chip spi0_chip_info = {
	...
	.cs_control		= arm9facile_spi_cs_set,
};
...
static int __init arm9facile_spi_board_register(void)
{
...
arch_initcall(arm9facile_spi_board_register);
...
static struct i2c_board_info __initdata arm9facile_i2c_board_info[] = {
// 	{
...
static struct mtd_partition arm9facile_nand_partition[] = {
	{
		.name   = "t2eng3250-boot",
		.offset = 0,
		.size   = (BLK_SIZE * 25)
	...
	{
		.name   = "t2eng3250-uboot",
		.offset = MTDPART_OFS_APPEND,
		.size   = (BLK_SIZE * 2)
	},
	{
		.name   = "t2eng3250-kernel",
		.offset = MTDPART_OFS_APPEND,
		.size   = (BLK_SIZE * 32)
	},
	{
		.name   = "t2eng3250-rootfs",
		.offset = MTDPART_OFS_APPEND,
		.size   = MTDPART_SIZ_FULL
	},
};

static struct mtd_partition * arm9facile_nand_partitions(int size, int *num_partitions)
{
	*num_partitions = ARRAY_SIZE(arm9facile_nand_partition);
	return arm9facile_nand_partition;
}
...
static struct lpc32XX_nand_cfg lpc32xx_nandcfg =
{
	...
	.partition_info = arm9facile_nand_partitions,
};
...
static struct platform_device *arm9facile_devs[] __initdata = {
	&lpc32xx_i2c0_device,
	&lpc32xx_i2c1_device,
	&lpc32xx_i2c2_device,
 ...
 */
static void __init arm9facile_board_init(void)
{
	u32 tmp;
	int i;
	...
	platform_add_devices(arm9facile_devs, ARRAY_SIZE(arm9facile_devs));
	...
	i2c_register_board_info(0, arm9facile_i2c_board_info,
		ARRAY_SIZE(arm9facile_i2c_board_info));
}
...
static irqreturn_t arm9facile_btn1_irq(int irq, void *dev)
{
...
static int __init arm9facile_button_setup(void)
{
	int ret;
	...
	ret = request_irq(IRQ_LPC32XX_GPI_03, arm9facile_btn1_irq,
...
device_initcall(arm9facile_button_setup);

MACHINE_START(ARM9FACILE, "T2 Engineering Arm9facile board with the LPC3250 Microcontroller")
	.boot_params	= 0x80000100,
	.map_io		= lpc32xx_map_io,
	.init_irq	= lpc32xx_init_irq,
	.timer		= &lpc32xx_timer,
	.init_machine	= arm9facile_board_init,
MACHINE_END

/* For backwards compatibility with older bootloaders only */
MACHINE_START(LPC3XXX, "T2 Engineering Arm9facile board with the LPC3250 Microcontroller")
	.boot_params	= 0x80000100,
	.map_io		= lpc32xx_map_io,
	.init_irq	= lpc32xx_init_irq,
	.timer		= &lpc32xx_timer,
